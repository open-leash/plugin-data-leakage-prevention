...
LABEL org.opencontainers.image.title="OpenLeash Data Leakage Prevention" \
      org.opencontainers.image.source="https://github.com/open-leash/plugin-data-leakage-prevention" \
      org.opencontainers.image.licenses="Apache-2.0"

WORKDIR /app
COPY plugins/container-runtime/server.mjs ./server.mjs
COPY plugins/plugin-data-leakage-prevention/dist ./plugin
